...
const Selector = (props: Iprops) => {
  ...
  return (
    <SelectorContainer width={width} onClick={() => toggleSelector()} style={IContainerStyle()} className={className}>
      <TextWrapper
        text={selectedData}
        fontWeight={600}
        fontSize={14}
      ...
      {openSelector && <CustomDropDownContainer width={dropDownWidth} position={position}>

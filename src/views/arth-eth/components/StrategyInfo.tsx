      ...
      <TextWrapper text={
        <div>
          <p className={'m-b-8'}>The ETH staking program is a simple way for users to earn a yield on their
            ETH by providing liquidity to the MahaDAO ecosystem.</p>
          <p className={'m-b-8'}>The ETH you'll contribute here is used as collateral to mint ARTH (an
            inflation-proof stablecoin) and then deposited into MahaLend to provide liquidity for the ecosystem.</p>
          <p className={'m-b-8'}>Rewards are given out in MAHA, the governance token. You can further lock MAHA for more staking rewards and other special benefits
